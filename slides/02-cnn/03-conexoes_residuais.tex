...
\begin{columns}
    \begin{column}{.5\linewidth}
        ...
        \end{itemize}
        \begin{align*}
            \mathbf{h}_1 &= f_1[\mathbf{x},\thetav_1] \\
            \mathbf{h}_2 &= f_2[\mathbf{h}_1,\thetav_2] \\
            \mathbf{h}_3 &= f_3[\mathbf{h}_2,\thetav_3] \\
            &\;\;\vdots \\
            \mathbf{h}_n &= f_n[\mathbf{h}_{n-1},\thetav_n]
        \end{align*}
    \end{column}
    \begin{column}{.5\linewidth}
        \centering
...
\begin{align*}
    \mathbf{h}_1 &= f_1[\mathbf{x},\thetav_1] \\
    \mathbf{h}_n &= f_n[\dots f_3[f_2[f_1[\mathbf{x},\thetav_1],\thetav_2],\thetav_3],\thetav_n]
\end{align*}
\vspace{0.5em}
\begin{center}
\begin{tikzpicture}[every node/.style={font=\small}, node distance=0.6cm]
...
\begin{itemize}
    ...
    \item Em redes muito profundas, $\partial \mathbf{y} / \partial \mathbf{x}$ se torna extremamente errático em relação à entrada.
...
\begin{columns}
    \begin{column}{.45\linewidth}
        \begin{align*}
            \mathbf{h}_1 &= \mathbf{x} + f_1[\mathbf{x},\thetav_1] \\
            \mathbf{h}_2 &= \mathbf{h}_1 + f_2[\mathbf{h}_1,\thetav_2] \\
            \mathbf{h}_3 &= \mathbf{h}_2 + f_3[\mathbf{h}_2,\thetav_3] \\
            \mathbf{h}_4 &= \mathbf{h}_3 + f_4[\mathbf{h}_3,\thetav_4]
        \end{align*}
    \end{column}
...
\vspace{0.6em}
\begin{itemize}
    \item \textbf{Por que ``residual''?} O bloco aprende só o \textbf{resíduo} $f(\mathbf{x}){=}H(\mathbf{x}){-}\mathbf{x}$ (a correção a aplicar sobre $\mathbf{x}$). Se a transformação ideal for a identidade, basta $f{\to}0$, fácil de aprender, o que resolve o paradoxo da degradação.
...
\end{itemize}
\begin{align*}
    \mathbf{y} = \;& \mathbf{x} + f_1[\mathbf{x}] \\
        & + f_2\bigl[\,\mathbf{x} + f_1[\mathbf{x}]\,\bigr] \\
        & + f_3\bigl[\,\mathbf{x} + f_1[\mathbf{x}] + f_2[\mathbf{x} + f_1[\mathbf{x}]]\,\bigr] \\
        & + f_4\bigl[\,\mathbf{x} + f_1[\mathbf{x}] + f_2[\mathbf{x} + f_1[\mathbf{x}]] + f_3[\mathbf{x} + f_1[\mathbf{x}] + f_2[\mathbf{x} + f_1[\mathbf{x}]]]\,\bigr]
\end{align*}
\begin{itemize}
...
\end{equation*}
\begin{itemize}
    \item Intuição: a derivada de $x + f(x)$ é $1 + f'(x)$; o \textbf{``1''} (o termo $\mathbf{I}$) é um \textbf{piso} que impede o gradiente de zerar.
    \item O termo $\mathbf{I}$ garante um caminho de gradiente que \textbf{não passa} por nenhum produto de derivadas.
    \begin{itemize}
...
\begin{itemize}
    \item Até aqui parece que $f_i[\mathbf{x}]$ poderia ser uma camada qualquer.
    \begin{itemize}
