...
Agora, calculamos $\boldsymbol{\theta}_{2}$ para a iteração $t=2$:
  ...
  Termo normalizador ($\mathbf{v}_2$):
    $$\mathbf{v}_{2} = \gamma \mathbf{v}_{1} + (1-\gamma )(\nabla_{\boldsymbol{\theta}_{1}}J)^2 = 0.999\begin{bmatrix} 0.004\\ 0.025 \end{bmatrix} + (1-0.999)\begin{bmatrix} (-1)^2\\ 8^2 \end{bmatrix} = \begin{bmatrix} 0.003996\\ 0.024975 \end{bmatrix} + 0.001\begin{bmatrix} 1\\ 64 \end{bmatrix} = \begin{bmatrix} 0.004996\\ 0.088975 \end{bmatrix}$$
