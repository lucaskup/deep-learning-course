...
- Os arquivos `*_formulario.tex` são folhas de fórmulas entregues junto com a prova, organizadas por blocos temáticos. Os formulários genéricos por unidade ficam na raiz de `exams/` por serem compartilhados entre semestres; um formulário específico de uma prova fica na pasta do semestre, com o mesmo prefixo da prova (`2026-2/2026_2_unidade4_formulario.tex`).
