...
\[
\mathrm{score}(h_t, s_1) = 1 \cdot 2 + 1 \cdot 2 = 4, \qquad
\mathrm{score}(h_t, s_2) = 1 + 1 = 2, \qquad
\mathrm{score}(h_t, s_3) = 0 - 1 = -1.
\]
...
\textbf{(g)} $0{,}881$ esquece $s_3$ no denominador ($54{,}60/(54{,}60+7{,}39)$); \textit{scores} negativos também entram na \textit{softmax}.
